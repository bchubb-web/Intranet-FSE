...
/**
 * Title: Contact Page
 * Slug: intranetbasetheme/page-home-contact
 * Categories: page
 * Keywords: page, contact, email
 * Post Types: page, wp_template
 * Viewport width: 1400
 */
?>

<!-- wp:pattern {"slug":"intranetbasetheme/text-centered-statement-small"}	/-->
...
<!-- wp:pattern {"slug":"intranetbasetheme/cta-subscribe-centered"}	/-->
