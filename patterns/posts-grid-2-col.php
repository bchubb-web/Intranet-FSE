 ...
 * Slug: intranetbasetheme/posts-grid-2-col
 * Categories: query
...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
	...
	<h2 class="wp-block-heading alignwide has-x-large-font-size" style="margin-top:0;line-height:1"><?php esc_html_e('Watch, Read, Listen', 'intranetbasetheme'); ?></h2>
	<!-- /wp:heading -->
		...
		<div class="wp-block-column" style="flex-basis:60%">
			...
			<div class="wp-block-query">
				...
				<div class="wp-block-group">
					...
					<!-- wp:post-excerpt {"excerptLength":35, "color":{"textColor":"var(--wp--preset--color--dark)"}} /-->
		...
		<div class="wp-block-column" style="flex-basis:40%">
			...
			<div class="wp-block-query">
				...
				<div class="wp-block-group">
					...
					<!-- wp:post-excerpt {"excerptLength":14,"fontSize":"small", "color": {"textColor":"dark"}} /-->
					<!-- wp:template-part {"slug":"post-meta"} /-->
